...
public abstract class CrudController<T, ID> {
    ...
    @Operation(summary = "Obter todos os objetos", description = "Retorna todos os objetos do tipo T")
    @ApiResponses(value = {
    ...
    @Operation(summary = "Obter objeto por ID", description = "Retorna um objeto do tipo T pelo seu ID")
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Sucesso"),
    ...
    @Operation(summary = "Criar novo objeto", description = "Cria um novo objeto do tipo T")
    @ApiResponses(value = {
    ...
    @Operation(summary = "Atualizar objeto", description = "Atualiza um objeto existente identificado pelo ID")
    @ApiResponses(value = {
    ...
    @Operation(summary = "Atualizar parcialmente objeto", description = "Atualiza parcialmente um objeto existente identificado pelo ID")
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Objeto atualizado com sucesso"),
            @ApiResponse(responseCode = "404", description = "Objeto não encontrado"),
            @ApiResponse(responseCode = "500", description = "Erro interno do servidor")
    ...
    @Operation(summary = "Deletar objeto", description = "Deleta um objeto identificado pelo ID")
    @ApiResponses(value = {
